...
- Not yet run on `H100!`; command: `uv run --extra cloud modal run modal_app.py::correctness --op silu`
...
- Notes: SiLU includes sigmoid work, so SoL is clearer than raw bandwidth.
