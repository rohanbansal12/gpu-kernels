"""Bench suite scaffold for the row_sum op."""
...
from gpu_kernels.ops.row_sum.triton_impl import DEFAULT_BLOCK
...
def main() -> None:
    ...
    raise NotImplementedError("implement benchmarks.suites.row_sum")
