"""Bench suite scaffold for the softmax op."""
...
from gpu_kernels.ops.softmax.triton_impl import DEFAULT_BLOCK
...
def main() -> None:
    ...
    raise NotImplementedError("implement benchmarks.suites.softmax")
