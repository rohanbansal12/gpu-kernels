"""Bench suite scaffold for the layernorm op."""
...
from gpu_kernels.ops.layernorm.triton_impl import DEFAULT_BLOCK
...
def main() -> None:
    ...
    raise NotImplementedError("implement benchmarks.suites.layernorm")
