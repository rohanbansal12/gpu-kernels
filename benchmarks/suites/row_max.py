"""Bench suite scaffold for the row_max op."""
...
from gpu_kernels.ops.row_max.triton_impl import DEFAULT_BLOCK
...
def main() -> None:
    ...
    raise NotImplementedError("implement benchmarks.suites.row_max")
